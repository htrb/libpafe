...
int felica_get_idm(const felica *f, uint8 *idm);
int felica_get_pmm(const felica *f, uint8 *idm);
...
int felica_request_service(felica *f, int *n, const uint16 *list, uint16 *data);
